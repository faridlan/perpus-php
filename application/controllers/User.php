...
class User extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['user'] = $this->M_Admin->get_tableid('tbl_login', 'level', 'Petugas');

		$this->data['title_web'] = 'Data User ';
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('user/admin/user_view', $this->data);
	...
	public function tambah()
	{
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('user/admin/tambah_view', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function add()
	{
		...
		if ($dd->num_rows() > 0) {
			...
			redirect(base_url('user/admin/tambah'));
		} else {
	...
	public function edit()
	{
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('user/admin/edit_view', $this->data);
		$this->load->view('footer_view', $this->data);
	}
	...
	public function detail()
	{
		...
		$this->load->view('user/admin/detail', $this->data);
	}
		...
		if (!$this->upload->do_upload('gambar')) {
			if ($this->input->post('pass') !== '') {
				...
				if ($this->session->userdata('level') == 'Petugas' || $this->session->userdata('level') == 'root') {
					...
					redirect(base_url('user/admin/edit/' . $id_login));
				}
			} else {
				$data = array(
					'nama' => $nama,
