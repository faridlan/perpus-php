...
class Dashboard extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['count_denda'] = $this->db->query("SELECT * from tbl_pinjam WHERE status = 'Dipinjam' AND tgl_kembali = 0 
		AND DATE(CONVERT_TZ(NOW(), '+00:00', '+07:00')) > tgl_balik")->num_rows();
