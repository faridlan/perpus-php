...
class Data extends CI_Controller
{
	...
	{
		$this->data['tahun'] = $this->M_Buku->gettahun();
	...
	public function report()
	{
		...
		if ($nilaifilter == 1) {
			$data['title'] = "Laporan Buku Berdasarkan Tanggal";
			$data['subtitle'] = "Dari Tanggal : " . $tanggalawal . ' s/d ' . $tanggalakhir;
			$data['datafilter'] = $this->M_Buku->filterbytanggal($tanggalawal, $tanggalakhir);
			$this->load->library('pdf');
			$this->pdf->setPaper('A4', 'landscape');
			$this->pdf->filename = "laporan-buku-berdasarkan-tanggal.pdf";
			$this->pdf->load_view('buku/print_report', $data);
		} elseif ($nilaifilter == 2) {
			$data['title'] = "Laporan Buku Berdasarkan Bulan";
			$data['subtitle'] = "Dari Bulan : " . $bulanawal . ' <br> Pada tahun : ' . $tahun1;
			$data['datafilter'] = $this->M_Buku->filterbybulan($tahun1, $bulanawal);
			$this->load->library('pdf');
			$this->pdf->setPaper('A4', 'landscape');
			$this->pdf->filename = "laporan-buku-berdasarkan-tanggal-bulan.pdf";
			$this->pdf->load_view('buku/print_report', $data);
		} elseif ($nilaifilter == 3) {
			$data['title'] = "Laporan Buku Berdasarkan Tahun";
			$data['subtitle'] = 'Tahun : ' . $tahun2;
			$data['datafilter'] = $this->M_Buku->filterbytahun($tahun2);
			$this->load->library('pdf');
			$this->pdf->setPaper('A4', 'landscape');
			$this->pdf->filename = "laporan-buku-berdasarkan-tahun.pdf";
			$this->pdf->load_view('buku/print_report', $data);
		}
	}
}
