    ...
    <ul class="sidebar-menu" data-widget="tree">
      <?php if ($this->session->userdata('level') == 'Petugas' || $this->session->userdata('level') == 'root') { ?>
        ...
        <li class="treeview 
            ...
            <?php if ($this->uri->uri_string() == 'anggota/tambah') {
              echo 'active';
            } ?>
            <?php if ($this->uri->uri_string() == 'anggota/edit/' . $this->uri->segment('3')) {
              echo 'active';
            } ?>
            ...
            <?php if ($this->uri->uri_string() == 'user/anggota') {
              echo 'active';
            } ?>
          ...
          <ul class="treeview-menu">
            ...
            <?php if ($this->uri->uri_string() == 'anggota/edit/' . $this->uri->segment('3')) {
              ...
              <a href="<?php echo base_url("anggota"); ?>" class="cursor">
                <span class="fa fa-user"></span> Data Anggota
              </a>
            </li>
          </ul>
        </li>
        <li class="treeview 
        <?php if ($this->uri->uri_string() == 'data/kategori') {
          echo 'active';
        } ?>
